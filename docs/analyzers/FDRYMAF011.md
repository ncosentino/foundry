# FDRYMAF011: Prefer [AgentTerminationCondition] for group chat members
...
```csharp
#pragma warning disable FDRYMAF011
[AgentGroupChatMember("code-review")]
[WorkflowRunTerminationCondition(typeof(KeywordTerminationCondition), "APPROVED")]
public class ApproverAgent { }
#pragma warning restore FDRYMAF011
```

## See Also

- [AI Integrations — Multi-Agent Orchestration](../ai-integrations.md#multi-agent-orchestration)
- [FDRYMAF009](FDRYMAF009.md) — condition declared on a non-agent class
- [FDRYMAF010](FDRYMAF010.md) — condition type does not implement IWorkflowTerminationCondition
