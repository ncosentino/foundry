# FDRYMAF016: Cycle detected in agent graph
...
```csharp
#pragma warning disable FDRYMAF016
// Not recommended — cycles cause infinite execution
#pragma warning restore FDRYMAF016
```
...
- [FDRYMAF022](FDRYMAF022.md) — graph contains unreachable agents
