# FDRYMAF004: Cyclic handoff chain detected
...
[FoundryAgent(Instructions = "Produce the final answer.")]
public class AgentC { }
```
...
```csharp
#pragma warning disable FDRYMAF004
[AgentHandoffsTo(typeof(AgentB))]
public class AgentA { }
#pragma warning restore FDRYMAF004
```
