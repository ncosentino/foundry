...
/// <summary>
/// One explicit artifact rehydration decision made by resolving a caller-supplied artifact
/// reference. Emitted exactly once per explicit rehydration request/outcome — every resolution
/// status, not only <see cref="HarnessArtifactOutcomeCategory.Resolved"/>. Never emitted when
/// resolution throws before reaching a decision (for example a pre-canceled token or a stale
/// execution binding), because no decision was made in that case.
/// </summary>
...
/// attached to the internal rehydration result this decision produced.
/// </param>
public sealed record HarnessArtifactRehydrationDecisionEvent(
