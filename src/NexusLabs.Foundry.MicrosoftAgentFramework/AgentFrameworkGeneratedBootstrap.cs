...
public static class AgentFrameworkGeneratedBootstrap
{
    ...
    /// Provider for the set of <c>[FoundryAgent]</c>-decorated agent types visible inside the scope.
    /// </param>
    ...
    /// <c>[AgentFunction]</c>, <c>[AgentFunctionGroup]</c>, or <c>[FoundryAgent]</c> types: the
