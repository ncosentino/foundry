...
/// <summary>
/// Declares a handoff target for a <see cref="FoundryAgentAttribute"/>-annotated agent.
...
/// </summary>
/// <remarks>
/// When the <c>NexusLabs.Foundry.MicrosoftAgentFramework.Generators</c> package is referenced, the source
...
/// <example>
/// <code>
/// [FoundryAgent(Instructions = "Triage incoming customer requests.")]
...
public sealed class AgentHandoffsToAttribute : Attribute
{
    ...
    /// The type of the target agent. Must be annotated with <see cref="FoundryAgentAttribute"/>.
    /// </param>
