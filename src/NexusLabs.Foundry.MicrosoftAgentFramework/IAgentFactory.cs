...
public interface IAgentFactory
{
    ...
    /// <see cref="FoundryAgentAttribute"/> on <typeparamref name="TAgent"/>.
    /// </summary>
    ...
    /// <see cref="FoundryAgentAttribute"/> on <typeparamref name="TAgent"/>, then applying
    ...
    /// <summary>
    /// Resolves the tools scoped to the <see cref="FoundryAgentAttribute"/> on
