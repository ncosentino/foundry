...
/// workspace. Every non-<see cref="Resolved"/> value is a first-class data outcome, never a
...
/// </summary>
/// <remarks>
/// <c>Expired</c> is intentionally not represented here yet. There is no retention/TTL policy and
