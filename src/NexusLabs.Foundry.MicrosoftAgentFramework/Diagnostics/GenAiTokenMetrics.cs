...
/// to consider Foundry's measurements and MEAI's measurements part of the same metric
...
internal sealed class GenAiTokenMetrics : IGenAiTokenMetrics, IDisposable
{
    ...
    public void RecordTokenUsage(string tokenType, long tokenCount, GenAiTokenUsageTags tags)
    {
        ...
        // the OpenTelemetry SDK MetricStreamIdentity to consider Foundry's measurements and
