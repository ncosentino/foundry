...
/// <c>"NexusLabs.Foundry.MicrosoftAgentFramework.Pipelines"</c> does not accidentally pick
...
{
    private readonly ActivitySource _activitySource = new("NexusLabs.Foundry.MicrosoftAgentFramework.Pipelines.NoOp");
