...
/// <remarks>
/// <para>
/// When the <c>NexusLabs.Foundry.MicrosoftAgentFramework.Generators</c> source generator is used, strongly-typed
...
public interface IWorkflowFactory
{
    ...
    /// The type of the initial agent. Must be annotated with both <see cref="FoundryAgentAttribute"/>
    ...
    /// <see cref="FoundryAgentAttribute"/>. The callback can override any field — most
    ...
    /// from the agent's <see cref="FoundryAgentAttribute"/>; the callback overrides what it needs.
    /// </param>
