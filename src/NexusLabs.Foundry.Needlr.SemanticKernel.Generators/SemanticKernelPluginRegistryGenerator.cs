...
namespace NexusLabs.Foundry.Needlr.SemanticKernel.Generators;
...
public class SemanticKernelPluginRegistryGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateKernelPluginsSource(List<KernelPluginInfo> plugins, string safeAssemblyName)
    {
        ...
        builder.AppendLine("/// </summary>");
        builder.AppendLine("[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"NexusLabs.Foundry.Needlr.SemanticKernel.Generators\", \"1.0.0\")]");
