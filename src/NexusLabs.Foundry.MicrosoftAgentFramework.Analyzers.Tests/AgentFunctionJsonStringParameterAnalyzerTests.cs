...
public class MyTool
{
    ...
    public string Record([Description(""Findings to record"")] string {|FDRYMAF030:findingsJson|}) => findingsJson;
}
" + Attributes;
...
public class MyTool
{
    ...
    public string Save([Description(""Notes payload"")] string {|FDRYMAF030:notes_json|}) => notes_json;
}
" + Attributes;
...
public class MyTool
{
    [AgentFunction]
    [Description(""Records findings"")]
    public string Record([Description(""JSON array of findings"")] string {|FDRYMAF030:payload|}) => payload;
}
" + Attributes;
...
public class MyTool
{
    ...
    public string Save([Description(""json object payload"")] string {|FDRYMAF030:payload|}) => payload;
}
" + Attributes;
...
public class MyTool
{
    [AgentFunction]
    [Description(""Records findings"")]
    public string Record([Description(""JSON array of items"")] string {|FDRYMAF030:findingsJson|}) => findingsJson;
}
" + Attributes;
...
public class MyTool
{
    ...
    public string Record(
        ...
        [Description(""JSON array of findings"")] string {|FDRYMAF030:findingsJson|},
