...
" + Attributes;
    ...
    [Fact]
    public async Task Warning_FDRYMAF012_WhenAgentFunctionLacksDescription()
    {
        var code = @"
using NexusLabs.Foundry.MicrosoftAgentFramework;
...
" + Attributes;
    ...
    [Fact]
    public async Task Warning_FDRYMAF013_WhenParameterLacksDescription()
    {
        var code = @"
using NexusLabs.Foundry.MicrosoftAgentFramework;
using System.ComponentModel;
...
public class MyFunctions
{
    [AgentFunction]
    [Description(""Adds two numbers."")]
    public string Add(int {|FDRYMAF013:a|}, int {|FDRYMAF013:b|}) => (a + b).ToString();
}
" + Attributes;
    ...
    [Fact]
    public async Task Warning_FDRYMAF012_And_FDRYMAF013_WhenBothMissing()
    {
        var code = @"
using NexusLabs.Foundry.MicrosoftAgentFramework;
...
" + Attributes;
    ...
    [Fact]
    public async Task Warning_FDRYMAF013_OnlyForParamsWithoutDescription()
    {
        var code = @"
using NexusLabs.Foundry.MicrosoftAgentFramework;
using System.ComponentModel;
...
" + Attributes;
    ...
    [Fact]
    public async Task Warning_FDRYMAF012_PerMethod()
    {
        var code = @"
using NexusLabs.Foundry.MicrosoftAgentFramework;
