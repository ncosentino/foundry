...
namespace NexusLabs.Foundry.Evaluation;

/// <summary>
/// Carries an <see cref="IAgentRunDiagnostics"/> snapshot through the
/// <c>Microsoft.Extensions.AI.Evaluation</c> evaluator pipeline so that Foundry-native
...
public sealed class AgentRunDiagnosticsContext : EvaluationContext
{
    ...
    /// </summary>
    public const string ContextName = "Foundry Agent Run Diagnostics";
