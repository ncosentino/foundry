...
// agent loop, mirroring real-world consumer patterns like ExampleProduct:
//
...
// Resolve services — same pattern as ExampleProduct's orchestrator
...
var options = new IterativeLoopOptions
{
    ...
    // This mirrors ExampleProduct's pattern of reporting progress via SignalR.
...
// consumers (like ExampleProduct) read from this accessor after the run
