...
public sealed class CopilotChatClientOptions
{
    ...
    /// is not specified by the caller. Defaults to <c>claude-sonnet-4.5</c>.
    /// </summary>
    ...
    /// Defaults to <c>NexusLabs.Foundry/0.1.0</c>.
    /// </summary>
    public string EditorVersion { get; set; } = "NexusLabs.Foundry/0.1.0";
