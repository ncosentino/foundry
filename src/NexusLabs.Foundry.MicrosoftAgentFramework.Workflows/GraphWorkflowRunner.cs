...
using ProgressEvents = NexusLabs.Foundry.MicrosoftAgentFramework.Progress;
...
/// Foundry-native executor, depending on declared topology.
/// </summary>
/// <remarks>
...
internal sealed class GraphWorkflowRunner : IGraphWorkflowRunner
{
    ...
    private async Task<IDagRunResult> RunWithFoundryExecutorAsync(
        GraphTopology topology,
        string graphName,
        string input,
        ProgressEvents.IProgressReporter? progress,
