...
internal sealed class MafGeneratorTestRunner
{
    ...
    public const string MafAttributeDefinitions = """
        namespace NexusLabs.Foundry.MicrosoftAgentFramework
        {
            ...
            {
                System.Threading.Tasks.Task<NexusLabs.Foundry.MicrosoftAgentFramework.Diagnostics.IDagRunResult> RunGraphAsync(
                    string graphName,
                    string input,
                    NexusLabs.Foundry.MicrosoftAgentFramework.Progress.IProgressReporter progress = null,
            ...
            public sealed record AgentFrameworkBuilder
            {
                ...
                public AgentFrameworkBuilder AddAgentFunctions(System.Collections.Generic.IReadOnlyList<System.Type> functionTypes) => this;
            }
        }
        ...
        {
            public class KeywordTerminationCondition : NexusLabs.Foundry.MicrosoftAgentFramework.IWorkflowTerminationCondition
            {
                public KeywordTerminationCondition(string keyword, string agentId = null) { }
            }

            public class RegexTerminationCondition : NexusLabs.Foundry.MicrosoftAgentFramework.IWorkflowTerminationCondition
            {
            ...
            public static class StreamingRunWorkflowExtensions
            {
                public static System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyDictionary<string, string>> RunAsync(
                    ...
                    string message,
                    System.Collections.Generic.IReadOnlyList<NexusLabs.Foundry.MicrosoftAgentFramework.IWorkflowTerminationCondition> conditions,
