...
public sealed class LangfuseOptionsTests
{
    ...
    public void Defaults_MatchNeedlrTelemetrySourceNames()
    {
        ...
        Assert.Equal("NexusLabs.Foundry.MicrosoftAgentFramework", options.AgentActivitySourceName);
        Assert.Equal("NexusLabs.Foundry.MicrosoftAgentFramework", options.AgentMeterName);
