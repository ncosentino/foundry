...
public sealed class LangfuseClientFacadeTests
{
    ...
    [Fact]
    public void AddFoundryLangfuse_Configured_RegistersCompleteNonOwningFacadeWithExactSpecializedIdentities()
    {
    ...
    [Fact]
    public void AddFoundryLangfuse_Configured_PreservesHostSampler()
    {
    ...
    [Fact]
    public async Task AddFoundryLangfuse_Configured_ComposesFacadeFromPreRegisteredSpecializedClients()
    {
    ...
    [Fact]
    public void AddFoundryLangfuse_Configured_PreRegisteredFacadeIsAuthoritativeForSpecializedClients()
    {
    ...
    [Fact]
    public void AddFoundryLangfuse_Configured_PreRegisteredFacadeFactoryIsRejected()
    {
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddFoundryLangfuse_Configured_KeyedFacadeDoesNotReplaceUnkeyedBuiltInFacade()
    {
    ...
    [Fact]
    public void AddFoundryLangfuse_Configured_KeyedScopedSpecializedClientDoesNotAffectDefaultFacade()
    {
        var services = new ServiceCollection();
    ...
    public void AddFoundryLangfuse_Configured_NonSingletonSpecializedOverrideIsRejected(
    ...
    [Fact]
    public async Task AddFoundryLangfuse_Configured_FacadeBeginsAndLinksExperimentRun()
    {
    ...
    [Fact]
    public async Task AddFoundryLangfuse_Disabled_RegistersCoherentNoOpFacadeWithExactSpecializedIdentities()
    {
        var services = new ServiceCollection();
        services.AddFoundryLangfuse(options => options.Enabled = false);
    ...
    [Fact]
    public void AddFoundryLangfuse_Disabled_ReplacesPreRegisteredSpecializedClientWithCoherentNoOp()
    {
        using var scoreHttp = LangfuseHttpStub.Create(
    ...
    [Fact]
    public void AddFoundryLangfuse_ProviderDisposal_ShutsDownTracerBeforeDiOwnedHttpTransport()
    {
        var handler = new TrackingHttpMessageHandler();
