...
namespace NexusLabs.Foundry.Needlr.SemanticKernel.Tests;
...
public sealed class SourceGenIntegrationTests
{
    ...
    public void SemanticKernel_PackageHasOwnTypeRegistry()
    {
        ...
        var typeRegistryType = semanticKernelAssembly.GetType("NexusLabs.Foundry.Needlr.SemanticKernel.Generated.TypeRegistry");
    ...
    {
        var semanticKernelAssembly = typeof(SemanticKernelSyringeExtensions).Assembly;
        var moduleInitializerType = semanticKernelAssembly.GetType("NexusLabs.Foundry.Needlr.SemanticKernel.Generated.NeedlrSourceGenModuleInitializer");
