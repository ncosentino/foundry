...
namespace NexusLabs.Foundry.Evaluation.Reporting;
...
public sealed class MeaiReportingExperimentItem
{
    ...
    /// <summary>Gets the MEAI execution name mapped from the Foundry run ID.</summary>
    public string ExecutionName => _scenarioRun.ExecutionName;

    /// <summary>Gets the MEAI scenario name mapped from the Foundry case ID.</summary>
