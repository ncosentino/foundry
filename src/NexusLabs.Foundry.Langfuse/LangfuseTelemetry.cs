...
/// <summary>
/// Entry point for exporting Foundry agent telemetry to Langfuse without requiring a generic
...
/// providers that subscribe to Foundry's <c>gen_ai</c> activity source and meters and export them
