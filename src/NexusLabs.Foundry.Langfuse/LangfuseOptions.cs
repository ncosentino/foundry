...
/// </para>
/// <para>
/// Foundry emits OpenTelemetry traces and metrics under well-known source and meter names.
...
public sealed record LangfuseOptions
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether Foundry's <c>gen_ai</c> metrics (including the
    ...
    /// calling <c>AddFoundryLangfuse</c>; that dependency-injection registration takes precedence.
    ...
    /// <summary>
    /// Gets or sets the name of Foundry's agent <see cref="System.Diagnostics.ActivitySource"/>
    ...
    /// <summary>
    /// Gets or sets the name of Foundry's agent <see cref="System.Diagnostics.Metrics.Meter"/>
    /// to export. Defaults to <see cref="AgentFrameworkMetricsOptions.MeterName"/>'s default.
    /// </summary>
    ...
    /// histogram shared by Foundry and MEAI. Defaults to
