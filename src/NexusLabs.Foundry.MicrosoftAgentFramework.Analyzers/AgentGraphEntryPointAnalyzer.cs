...
/// <remarks>
/// <para>
/// <b>FDRYMAF017</b> (Error): A named graph has edges but no <c>[AgentGraphEntry]</c>.
/// </para>
/// <para>
/// <b>FDRYMAF018</b> (Error): A named graph has multiple <c>[AgentGraphEntry]</c> declarations.
/// </para>
/// </remarks>
...
public sealed class AgentGraphEntryPointAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(compilationContext =>
        {
            ...
            // graphName → set of edge attribute locations (for reporting FDRYMAF017)
            ...
            compilationContext.RegisterCompilationEndAction(endContext =>
            {
                ...
                foreach (var graphName in allGraphNames)
                {
                    ...
                    {
                        // FDRYMAF017: edges exist but no entry point
                    ...
                    {
                        // FDRYMAF018: multiple entry points
