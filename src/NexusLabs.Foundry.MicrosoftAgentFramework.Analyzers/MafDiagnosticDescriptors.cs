...
public static class MafDiagnosticDescriptors
{
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor HandoffsToTargetNotFoundryAgent = new(
        id: MafDiagnosticIds.HandoffsToTargetNotFoundryAgent,
        title: "[AgentHandoffsTo] target type is not a declared agent",
        messageFormat: "'{0}' is referenced as a handoff target but is not decorated with [FoundryAgent]. Handoff targets must be registered agent types.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Types used as handoff targets in [AgentHandoffsTo] must also be decorated with [FoundryAgent] so Foundry can register and resolve them. Add [FoundryAgent] to the target type, or remove it from [AgentHandoffsTo].",
        helpLinkUri: HelpLinkBase + "FDRYMAF001.md");

    /// <summary>
    /// FDRYMAF002: <c>[AgentGroupChatMember("g")]</c> group "g" has fewer than two members.
    /// </summary>
    public static readonly DiagnosticDescriptor GroupChatTooFewMembers = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF002.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);

    /// <summary>
    /// FDRYMAF003: A class has <c>[AgentHandoffsTo]</c> but is not decorated with <c>[FoundryAgent]</c>.
    /// </summary>
    public static readonly DiagnosticDescriptor HandoffsToSourceNotFoundryAgent = new(
        id: MafDiagnosticIds.HandoffsToSourceNotFoundryAgent,
        title: "[AgentHandoffsTo] source class is not a declared agent",
        messageFormat: "'{0}' has [AgentHandoffsTo] but is not decorated with [FoundryAgent]. The source agent of a handoff workflow must itself be a declared agent.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "The class that carries [AgentHandoffsTo] is the initial agent of a handoff workflow and must also be registered with Foundry via [FoundryAgent]. Add [FoundryAgent] to the class, or remove [AgentHandoffsTo] if it was added by mistake.",
        helpLinkUri: HelpLinkBase + "FDRYMAF003.md");
    ...
    public static readonly DiagnosticDescriptor CyclicHandoffChain = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF004.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor UnresolvedFunctionGroupReference = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF005.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor DuplicateSequenceOrder = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF006.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor GapInSequenceOrder = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF007.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor OrphanAgent = new(
        ...
        messageFormat: "'{0}' is decorated with [FoundryAgent] but does not appear in any topology declaration ([AgentHandoffsTo], [AgentGroupChatMember], or [AgentSequenceMember]). It will not be wired into any generated workflow.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Info,
        isEnabledByDefault: true,
        description: "An agent registered with [FoundryAgent] is not referenced in any topology. It will not appear in any source-generated workflow method. This may be intentional (e.g. the agent is used programmatically), but is often an oversight. Add a topology attribute or remove [FoundryAgent] if the class is not an agent.",
        helpLinkUri: HelpLinkBase + "FDRYMAF008.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);

    /// <summary>
    /// FDRYMAF009: <c>[WorkflowRunTerminationCondition]</c> declared on a non-agent class.
    /// </summary>
    public static readonly DiagnosticDescriptor WorkflowRunTerminationConditionOnNonAgent = new(
        ...
        messageFormat: "'{0}' has [WorkflowRunTerminationCondition] but is not decorated with [FoundryAgent]. Termination conditions are only evaluated for registered agents.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "A class carries [WorkflowRunTerminationCondition] but is not decorated with [FoundryAgent], so it will never be part of a generated workflow and the condition will never be evaluated. Either add [FoundryAgent] to make it a registered agent, or remove [WorkflowRunTerminationCondition].",
        helpLinkUri: HelpLinkBase + "FDRYMAF009.md");

    /// <summary>
    /// FDRYMAF010: Condition type does not implement <c>IWorkflowTerminationCondition</c>.
    /// </summary>
    public static readonly DiagnosticDescriptor TerminationConditionTypeInvalid = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF010.md");

    /// <summary>
    /// FDRYMAF011: Prefer <c>[AgentTerminationCondition]</c> over
    ...
    public static readonly DiagnosticDescriptor PreferAgentTerminationConditionForGroupChat = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF011.md");

    /// <summary>
    /// FDRYMAF012: <c>[AgentFunction]</c> method has no <c>[Description]</c> attribute.
    /// </summary>
    public static readonly DiagnosticDescriptor AgentFunctionMissingDescription = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF012.md");

    /// <summary>
    /// FDRYMAF013: Parameter of an <c>[AgentFunction]</c> method is missing a <c>[Description]</c> attribute.
    /// </summary>
    public static readonly DiagnosticDescriptor AgentFunctionParameterMissingDescription = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF013.md");

    /// <summary>
    /// FDRYMAF014: A type in <c>FunctionTypes</c> on <c>[FoundryAgent]</c> has no
    ...
    public static readonly DiagnosticDescriptor AgentFunctionTypesMiswired = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF014.md");

    /// <summary>
    /// FDRYMAF015: <c>.ToString()</c> is called on a tool result property that may
    ...
    public static readonly DiagnosticDescriptor GraphCycleDetected = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF016.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor GraphNoEntryPoint = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF017.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor GraphMultipleEntryPoints = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF018.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);

    /// <summary>
    /// FDRYMAF019: An <c>[AgentGraphEdge]</c> references a target that is not a declared agent.
    /// </summary>
    public static readonly DiagnosticDescriptor GraphEdgeTargetNotAgent = new(
        ...
        messageFormat: "'{0}' is referenced as a graph edge target but is not decorated with [FoundryAgent]. Graph edge targets must be registered agent types.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Types used as targets in [AgentGraphEdge] must be decorated with [FoundryAgent] so Foundry can register and resolve them. Add [FoundryAgent] to the target type, or remove it from [AgentGraphEdge].",
        helpLinkUri: HelpLinkBase + "FDRYMAF019.md");

    /// <summary>
    /// FDRYMAF020: A class has <c>[AgentGraphEdge]</c> but is not a declared agent.
    /// </summary>
    public static readonly DiagnosticDescriptor GraphEdgeSourceNotAgent = new(
        ...
        messageFormat: "'{0}' has [AgentGraphEdge] but is not decorated with [FoundryAgent]. The source of a graph edge must be a declared agent.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "The class that carries [AgentGraphEdge] is a node in the agent graph and must be registered with Foundry via [FoundryAgent]. Add [FoundryAgent] to the class, or remove [AgentGraphEdge] if it was added by mistake.",
        helpLinkUri: HelpLinkBase + "FDRYMAF020.md");

    /// <summary>
    /// FDRYMAF021: A class has <c>[AgentGraphEntry]</c> but is not a declared agent.
    /// </summary>
    public static readonly DiagnosticDescriptor GraphEntryPointNotAgent = new(
        ...
        messageFormat: "'{0}' has [AgentGraphEntry] but is not decorated with [FoundryAgent]. The graph entry point must be a declared agent.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "The class that carries [AgentGraphEntry] is the starting node of the graph workflow and must be registered with Foundry via [FoundryAgent]. Add [FoundryAgent] to the class, or remove [AgentGraphEntry] if it was added by mistake.",
        helpLinkUri: HelpLinkBase + "FDRYMAF021.md");
    ...
    public static readonly DiagnosticDescriptor GraphUnreachableAgent = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF022.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);

    // FDRYMAF023 (GraphInvalidMaxSupersteps) removed — MaxSupersteps property
    ...
    public static readonly DiagnosticDescriptor GraphAllEdgesOptional = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF024.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor GraphTerminalNodeHasOutgoingEdges = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF027.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor WaitAnyIncompatibleWithCreateGraphWorkflow = new(
        ...
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "CreateGraphWorkflow returns a MAF Workflow object that uses Bulk Synchronous Parallel (BSP) execution with mandatory synchronization barriers. BSP always waits for all upstream nodes (WaitAll). Graphs that declare GraphJoinMode.WaitAny on any node must use RunGraphAsync, which uses Foundry's own executor with Task.WhenAny for WaitAny fan-in points.",
        helpLinkUri: HelpLinkBase + "FDRYMAF025.md",
        customTags: WellKnownDiagnosticTags.CompilationEnd);
    ...
    public static readonly DiagnosticDescriptor GraphConditionMethodInvalid = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF028.md");
    ...
    public static readonly DiagnosticDescriptor GraphReducerMethodInvalid = new(
        ...
        helpLinkUri: HelpLinkBase + "FDRYMAF029.md");

    /// <summary>
    /// FDRYMAF030: <c>[AgentFunction]</c> string parameter described as JSON could be JsonElement.
    /// </summary>
