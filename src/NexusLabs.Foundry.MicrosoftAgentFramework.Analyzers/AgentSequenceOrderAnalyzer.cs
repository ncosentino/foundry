...
/// <remarks>
/// <para>
/// <b>FDRYMAF006</b> (Error): Two or more agents in the same pipeline declare the same <c>Order</c> value.
/// </para>
/// <para>
/// <b>FDRYMAF007</b> (Warning): The <c>Order</c> values in a pipeline are not contiguous — a gap exists.
/// </para>
/// </remarks>
        ...
        context.RegisterCompilationStartAction(compilationContext =>
        {
            ...
            compilationContext.RegisterCompilationEndAction(endContext =>
            {
                foreach (var kvp in pipelineEntries)
                {
                    ...
                    // FDRYMAF006: duplicate Order values
                    ...
                    // FDRYMAF007: gap in Order sequence — only when no duplicate errors and 2+ members
