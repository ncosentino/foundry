...
/// </summary>
/// <remarks>
/// <b>FDRYMAF009</b> (Warning): <c>[WorkflowRunTerminationCondition]</c> is declared on a class
/// that is not also decorated with <c>[FoundryAgent]</c>.<br/>
/// <b>FDRYMAF010</b> (Error): The <c>conditionType</c> passed to
...
/// <b>FDRYMAF011</b> (Info): <c>[WorkflowRunTerminationCondition]</c> is declared on a
...
public sealed class TerminationConditionAnalyzer : DiagnosticAnalyzer
{
    ...
    private const string WorkflowRunTerminationConditionAttributeName = "NexusLabs.Foundry.MicrosoftAgentFramework.WorkflowRunTerminationConditionAttribute";
    private const string AgentTerminationConditionAttributeName = "NexusLabs.Foundry.MicrosoftAgentFramework.AgentTerminationConditionAttribute";
    private const string IWorkflowTerminationConditionName = "NexusLabs.Foundry.MicrosoftAgentFramework.IWorkflowTerminationCondition";
    ...
    private static void AnalyzeType(SymbolAnalysisContext context)
    {
        ...
        foreach (var attr in workflowRunConditionAttrs)
        {
            ...
            // FDRYMAF009: [WorkflowRunTerminationCondition] on a non-agent class
            if (!isAgent)
            {
            ...
            // FDRYMAF010: conditionType doesn't implement IWorkflowTerminationCondition
            ...
            // FDRYMAF011: [WorkflowRunTerminationCondition] on [AgentGroupChatMember]
