...
public class AgentFactoryTests
{
    private static IAgentFactory CreateFactory(
        Func<AgentFrameworkBuilder, Assembly, AgentFrameworkBuilder>? configure = null)
    {
    ...
    public void BuildAgentFactory_DuplicateFullName_ThrowsInvalidOperationWithBothTypes()
    {
        ...
        var syringe = new AgentFrameworkBuilder
        {
            ServiceProvider = sp,
    ...
    // -------------------------------------------------------------------------
    // Missing [FoundryAgent] attribute
    // -------------------------------------------------------------------------
    ...
    {
        var methods = typeof(NeedlrAgentFrameworkExtensions)
...
[FoundryAgent(Instructions = "You are a test agent for AgentFactory tests.")]
