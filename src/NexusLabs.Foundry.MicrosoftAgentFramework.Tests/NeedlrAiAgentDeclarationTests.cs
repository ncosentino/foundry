...
/// <summary>
/// Tests for <see cref="FoundryAgentAttribute"/>-based agent declaration and resolution,
/// including parity tests between <see cref="IAgentFactory.CreateAgent{TAgent}()"/> and
/// <see cref="IAgentFactory.CreateAgent(string)"/>.
/// </summary>
public class FoundryAgentDeclarationTests
{
    private static IAgentFactory BuildFactory(Func<AgentFrameworkBuilder, AgentFrameworkBuilder> configure)
    {
    ...
    [Fact]
    public void CreateAgent_ByType_WithFoundryAgentAttribute_ReturnsNonNullAgent()
    {
    ...
    [Fact]
    public void CreateAgent_ByType_WithNoFoundryAgentAttribute_ThrowsInvalidOperation()
    {
        ...
        Assert.Contains("[FoundryAgent]", ex.Message);
    }
