...
using static NexusLabs.Foundry.MicrosoftAgentFramework.Tests.IterativeLoopDiagnosticsIntegrationTestsHelpers;
...
public sealed class IterativeLoopDiagnosticsIntegrationTests
{
    ...
    {
        var sourceName = "NexusLabs.Foundry.MicrosoftAgentFramework";
