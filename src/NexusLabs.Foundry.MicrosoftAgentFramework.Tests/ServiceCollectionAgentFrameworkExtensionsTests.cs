...
/// <c>AddFoundryAgentFramework</c> overloads, the <see cref="IServiceCollection"/>-based
...
{
    [Fact]
    public void AddFoundryAgentFramework_RegistersIAgentFactory()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());

        services.AddFoundryAgentFramework();
    ...
    [Fact]
    public void AddFoundryAgentFramework_RegistersIWorkflowFactory()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
    ...
    [Fact]
    public void AddFoundryAgentFramework_RegistersInfrastructureServices()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
    ...
    [Fact]
    public void AddFoundryAgentFramework_SameCodePath_AsSyringeBuilder()
    {
        ...
        extensionServices.AddFoundryAgentFramework();
    ...
    [Fact]
    public void AddFoundryAgentFramework_CalledTwice_DoesNotThrow()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
    ...
    [Fact]
    public void UsingAgentFramework_And_AddFoundryAgentFramework_BothCalled_AllTypesResolve()
    {
        // Simulates when a plugin calls AddFoundryAgentFramework() during
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_InvokesDelegate()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());

        var configureInvoked = false;
        services.AddFoundryAgentFramework(af =>
        {
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_ChatClientFactoryPropagates()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());

        var mockChatClient = new Mock<Microsoft.Extensions.AI.IChatClient>();
        services.AddFoundryAgentFramework(af => af
            .Configure(opts => opts.ChatClientFactory = _ => mockChatClient.Object));
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_MetricsOptionsPropagatesToIAgentMetrics()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_NullServices_Throws()
    {
        Assert.Throws<ArgumentNullException>(() =>
            ServiceCollectionAgentFrameworkExtensions.AddFoundryAgentFramework(
                services: null!,
                configure: af => af));
    }

    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_NullConfigure_Throws()
    {
        var services = new ServiceCollection();
        Assert.Throws<ArgumentNullException>(() =>
            services.AddFoundryAgentFramework(
                configure: (Func<AgentFrameworkBuilder, AgentFrameworkBuilder>)null!));
    }

    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_RegistersAllInfrastructure()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithFactoryDelegate_InvokesFactory()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
        ...
        {
            factoryInvoked = true;
            return new AgentFrameworkBuilder
            {
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithFactoryDelegate_NullConfigure_Throws()
    {
        var services = new ServiceCollection();
        Assert.Throws<ArgumentNullException>(() =>
            services.AddFoundryAgentFramework(
                configure: (Func<AgentFrameworkBuilder>)null!));
    }

    /// <summary>
    /// The factory overload (Func&lt;AgentFrameworkBuilder&gt;) is documented as routing
    /// through the main configure overload (Func&lt;AgentFrameworkBuilder, AgentFrameworkBuilder&gt;).
    /// This test asserts that both paths produce equivalent service registrations when given
    /// equivalent configurations.
    /// </summary>
    [Fact]
    public void AddFoundryAgentFramework_WithFactoryDelegate_RoutesThroughMainConfigureOverload()
    {
        ...
        mainOverloadServices.AddFoundryAgentFramework(af => af
        ...
        factoryOverloadServices.AddFoundryAgentFramework(() =>
            new AgentFrameworkBuilder
            {
                ServiceProvider = new ServiceCollection().BuildServiceProvider(),
            }.ConfigureMetrics(o => o.MeterName = "Routing.Test"));
    ...
    /// <c>AddFoundryAgentFramework(configure)</c> registers via
    ...
    /// wins because <c>TryAddSingleton&lt;BuiltAgentFrameworkBuilder&gt;</c> sees the plugin's
    ...
    /// <summary>
    /// When a single plugin invokes <c>AddFoundryAgentFramework(configure)</c> twice with
    ...
    /// <c>TryAddSingleton&lt;BuiltAgentFrameworkBuilder&gt;</c> means the second call is
    ...
    [Fact]
    public void AddFoundryAgentFramework_WithConfigure_SameCodePath_AsSyringeBuilder()
    {
        var config = new ConfigurationBuilder().Build();
        ...
        var extensionServices = new ServiceCollection();
        extensionServices.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
        extensionServices.AddFoundryAgentFramework(af => af
            .ConfigureMetrics(o => o.MeterName = "Parity.Test"));
        var extensionProvider = extensionServices.BuildServiceProvider();
    ...
    [Fact]
    public void AddFoundryAgentFramework_RegistersIPipelineMetrics_AsNoOpByDefault()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
        ...
        Assert.Equal("NexusLabs.Foundry.MicrosoftAgentFramework.Pipelines.NoOp", metrics!.ActivitySource.Name);
    }

    [Fact]
    public void AddFoundryAgentFramework_WithConfigurePipelineMetrics_ResolvesRealPipelineMetrics()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
    ...
    [Fact]
    public void AddFoundryAgentFramework_PipelineMetricsAndAgentMetrics_ResolveIndependently()
    {
        var services = new ServiceCollection();
        services.AddSingleton<IConfiguration>(new ConfigurationBuilder().Build());
