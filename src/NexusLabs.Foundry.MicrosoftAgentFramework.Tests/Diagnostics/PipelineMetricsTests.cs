...
namespace NexusLabs.Foundry.MicrosoftAgentFramework.Tests.Diagnostics;
...
public sealed class PipelineMetricsTests
{
    ...
    public void Defaults_MeterAndActivitySource_UseDefaultName()
    {
        ...
        Assert.Equal("NexusLabs.Foundry.MicrosoftAgentFramework.Pipelines", metrics.ActivitySource.Name);
    }
    ...
    private sealed class MetricCapture : IDisposable
    {
        ...
        {
            _meterName = $"NexusLabs.Foundry.MicrosoftAgentFramework.Tests.{Guid.NewGuid():N}";
