...
[FoundryAgent(Instructions = "Draft raw content for a topic.")]
[AgentSequenceMember("wf-content-pipeline", 1)]
public sealed class WriterSeqWfAgent { }

[FoundryAgent(Instructions = "Edit and improve a content draft.")]
[AgentSequenceMember("wf-content-pipeline", 2)]
public sealed class EditorSeqWfAgent { }

[FoundryAgent(Instructions = "Format content for publication.")]
