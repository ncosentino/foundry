...
[FoundryAgent(Instructions = "Entry node for test graph.")]
...
[FoundryAgent(Instructions = "Worker in WaitAny test graph.")]
[AgentGraphEdge("wf-waitany-test", typeof(WaitAnySinkAgent))]
internal sealed class WaitAnyWorkerAgent { }

[FoundryAgent(Instructions = "Sink with WaitAny join mode — should throw.")]
...
[FoundryAgent(Instructions = "Entry for reducer BSP test graph.")]
...
[FoundryAgent(Instructions = "Worker A for reducer BSP test graph.")]
[AgentGraphEdge("wf-reducer-bsp-graph", typeof(ReducerBspSinkAgent))]
internal sealed class ReducerBspWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for reducer BSP test graph.")]
[AgentGraphEdge("wf-reducer-bsp-graph", typeof(ReducerBspSinkAgent))]
internal sealed class ReducerBspWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for reducer BSP test graph.")]
...
[FoundryAgent(Instructions = "Entry for BSP exclusive choice test graph.")]
...
[FoundryAgent(Instructions = "Worker A for BSP exclusive choice test graph.")]
internal sealed class BspExclusiveWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for BSP exclusive choice test graph.")]
...
[FoundryAgent(Instructions = "Entry for BSP LLM choice test graph.")]
...
[FoundryAgent(Instructions = "Worker A for BSP LLM choice test graph.")]
internal sealed class BspLlmChoiceWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for BSP LLM choice test graph.")]
...
[FoundryAgent(Instructions = "Entry for BSP first matching test graph.")]
...
[FoundryAgent(Instructions = "Worker A for BSP first matching test graph.")]
internal sealed class BspFirstMatchWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for BSP first matching test graph.")]
...
[FoundryAgent(Instructions = "Entry for optional edge test graph.")]
...
[FoundryAgent(Instructions = "Worker with optional incoming edge.")]
[AgentGraphEdge("wf-optional-edge-graph", typeof(OptionalEdgeSinkAgent))]
internal sealed class OptionalEdgeWorkerAgent { }

[FoundryAgent(Instructions = "Sink for optional edge test graph.")]
