...
[FoundryAgent(Instructions = "Entry for condition routing graph.")]
...
[FoundryAgent(Instructions = "Gated worker, only runs when condition passes.")]
[AgentGraphEdge("cond-routing-graph", typeof(CondSinkAgent))]
internal sealed class CondGatedWorkerAgent { }

[FoundryAgent(Instructions = "Always-runs worker (unconditional edge).")]
[AgentGraphEdge("cond-routing-graph", typeof(CondSinkAgent))]
internal sealed class CondAlwaysWorkerAgent { }

[FoundryAgent(Instructions = "Sink for condition routing graph.")]
...
[FoundryAgent(Instructions = "Entry for required-fail graph.")]
...
[FoundryAgent(Instructions = "This is the optional-fail-worker that will fail.")]
[AgentGraphEdge("opt-fail-graph", typeof(OptFailSinkAgent))]
internal sealed class OptFailWorkerAgent { }

[FoundryAgent(Instructions = "This opt-ok worker will succeed.")]
[AgentGraphEdge("opt-fail-graph", typeof(OptFailSinkAgent))]
internal sealed class OptOkWorkerAgent { }

[FoundryAgent(Instructions = "Sink for optional-fail graph.")]
[AgentGraphNode("opt-fail-graph", JoinMode = GraphJoinMode.WaitAny)]
internal sealed class OptFailSinkAgent { }

// Mixed fail agents
[FoundryAgent(Instructions = "Entry for mixed-fail graph.")]
...
[FoundryAgent(Instructions = "Required worker that will fail.")]
[AgentGraphEdge("mix-fail-graph", typeof(MixReqFailSinkAgent))]
internal sealed class MixReqFailWorkerAgent { }

[FoundryAgent(Instructions = "Optional worker that succeeds.")]
[AgentGraphEdge("mix-fail-graph", typeof(MixReqFailSinkAgent))]
internal sealed class MixOptOkWorkerAgent { }

[FoundryAgent(Instructions = "Sink for mixed-fail graph.")]
...
[FoundryAgent(Instructions = "Entry for reducer graph.")]
...
[FoundryAgent(Instructions = "Worker A for reducer graph.")]
[AgentGraphEdge("reducer-graph", typeof(ReducerSinkAgent))]
internal sealed class ReducerWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for reducer graph.")]
[AgentGraphEdge("reducer-graph", typeof(ReducerSinkAgent))]
internal sealed class ReducerWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for reducer graph.")]
...
[FoundryAgent(Instructions = "Terminal for reducer graph.")]
...
[FoundryAgent(Instructions = "Entry for WaitAny timing graph.")]
...
[FoundryAgent(Instructions = "Fast worker (returns immediately).")]
[AgentGraphEdge("waitany-timing-graph", typeof(WaitAnySinkTimingAgent))]
internal sealed class FastTimingWorkerAgent { }

[FoundryAgent(Instructions = "Slow worker (delays 2 seconds).")]
[AgentGraphEdge("waitany-timing-graph", typeof(WaitAnySinkTimingAgent))]
internal sealed class SlowTimingWorkerAgent { }

[FoundryAgent(Instructions = "Sink with WaitAny for timing test.")]
...
[FoundryAgent(Instructions = "Entry for WaitAny events graph.")]
...
[FoundryAgent(Instructions = "Worker for WaitAny events graph.")]
[AgentGraphEdge("waitany-events-graph", typeof(WaitAnyEventsSinkAgent))]
internal sealed class WaitAnyEventsWorkerAgent { }

[FoundryAgent(Instructions = "Sink for WaitAny events graph.")]
...
[FoundryAgent(Instructions = "Entry for first-matching graph.")]
...
[FoundryAgent(Instructions = "Worker A for first-matching graph.")]
[AgentGraphEdge("first-matching-graph", typeof(FirstMatchSinkAgent))]
internal sealed class FirstMatchWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for first-matching graph.")]
[AgentGraphEdge("first-matching-graph", typeof(FirstMatchSinkAgent))]
internal sealed class FirstMatchWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for first-matching graph.")]
...
[FoundryAgent(Instructions = "Entry for exclusive-choice graph.")]
...
[FoundryAgent(Instructions = "Worker A for exclusive-choice graph.")]
internal sealed class ExclusiveWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for exclusive-choice graph.")]
internal sealed class ExclusiveWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for exclusive-choice graph.")]
...
[FoundryAgent(Instructions = "Entry for LLM choice graph.")]
...
[FoundryAgent(Instructions = "Worker A for LLM choice graph.")]
internal sealed class LlmChoiceWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for LLM choice graph.")]
...
[FoundryAgent(Instructions = "Entry for LLM choice number routing graph.")]
...
[FoundryAgent(Instructions = "Worker A for LLM choice number routing graph.")]
internal sealed class LlmChoiceNumberWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for LLM choice number routing graph.")]
...
[FoundryAgent(Instructions = "Entry for node override graph.")]
...
[FoundryAgent(Instructions = "Worker A for node override graph.")]
[AgentGraphEdge("node-override-graph", typeof(NodeOverrideSinkAgent))]
internal sealed class NodeOverrideWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for node override graph.")]
[AgentGraphEdge("node-override-graph", typeof(NodeOverrideSinkAgent))]
internal sealed class NodeOverrideWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for node override graph.")]
...
[FoundryAgent(Instructions = "Entry for fan-in without reducer.")]
...
[FoundryAgent(Instructions = "Worker A for fan-in.")]
[AgentGraphEdge("wf-waitany-fanin", typeof(FanInSinkAgent))]
internal sealed class FanInWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for fan-in.")]
[AgentGraphEdge("wf-waitany-fanin", typeof(FanInSinkAgent))]
internal sealed class FanInWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for fan-in.")]
...
[FoundryAgent(Instructions = "Entry for WaitAny cancellation graph.")]
...
[FoundryAgent(Instructions = "This is the fast-cancel-worker that returns quickly.")]
[AgentGraphEdge("waitany-cancel-graph", typeof(WaitAnyCancelSinkAgent))]
internal sealed class FastCancelWorkerAgent { }

[FoundryAgent(Instructions = "This is the slow-cancel-worker that delays.")]
[AgentGraphEdge("waitany-cancel-graph", typeof(WaitAnyCancelSinkAgent))]
internal sealed class SlowCancelWorkerAgent { }

[FoundryAgent(Instructions = "Sink with WaitAny for cancellation test.")]
...
[FoundryAgent(Instructions = "Entry for concurrent reducer graph.")]
...
[FoundryAgent(Instructions = "This is the worker-a for concurrent reducer.")]
[AgentGraphEdge("concurrent-reducer-graph", typeof(ConcReducerSinkAgent))]
internal sealed class ConcReducerWorkerAAgent { }

[FoundryAgent(Instructions = "This is the worker-b for concurrent reducer.")]
[AgentGraphEdge("concurrent-reducer-graph", typeof(ConcReducerSinkAgent))]
internal sealed class ConcReducerWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for concurrent reducer graph.")]
...
[FoundryAgent(Instructions = "Entry for throwing condition graph.")]
...
[FoundryAgent(Instructions = "Worker for throwing condition graph.")]
...
[FoundryAgent(Instructions = "Entry for throwing reducer graph.")]
...
[FoundryAgent(Instructions = "Worker A for throwing reducer graph.")]
[AgentGraphEdge("throwing-reducer-graph", typeof(ThrowReducerSinkAgent))]
internal sealed class ThrowReducerWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for throwing reducer graph.")]
[AgentGraphEdge("throwing-reducer-graph", typeof(ThrowReducerSinkAgent))]
internal sealed class ThrowReducerWorkerBAgent { }

[FoundryAgent(Instructions = "Sink for throwing reducer graph.")]
...
[FoundryAgent(Instructions = "Entry for all-matching graph.")]
...
[FoundryAgent(Instructions = "Worker A for all-matching graph.")]
[AgentGraphEdge("all-matching-graph", typeof(AllMatchSinkAgent))]
internal sealed class AllMatchWorkerAAgent { }

[FoundryAgent(Instructions = "Worker B for all-matching graph.")]
[AgentGraphEdge("all-matching-graph", typeof(AllMatchSinkAgent))]
internal sealed class AllMatchWorkerBAgent { }

[FoundryAgent(Instructions = "Worker C for all-matching graph.")]
[AgentGraphEdge("all-matching-graph", typeof(AllMatchSinkAgent))]
internal sealed class AllMatchWorkerCAgent { }

[FoundryAgent(Instructions = "Sink for all-matching graph.")]
...
[FoundryAgent(Instructions = "Entry for no-matching-edge graph.")]
...
[FoundryAgent(Instructions = "Worker for no-matching-edge graph.")]
...
[FoundryAgent(Instructions = "Entry for agent-throws required graph.")]
...
[FoundryAgent(Instructions = "This is the throws-worker that will explode.")]
internal sealed class AgentThrowsReqWorkerAgent { }

[FoundryAgent(Instructions = "Ok worker for agent-throws required graph.")]
internal sealed class AgentThrowsReqOkAgent { }

[FoundryAgent(Instructions = "Entry for agent-throws optional graph.")]
...
[FoundryAgent(Instructions = "This is the throws-worker that will explode (optional).")]
[AgentGraphEdge("agent-throws-opt-graph", typeof(AgentThrowsOptSinkAgent))]
internal sealed class AgentThrowsOptWorkerAgent { }

[FoundryAgent(Instructions = "Ok worker for agent-throws optional graph.")]
[AgentGraphEdge("agent-throws-opt-graph", typeof(AgentThrowsOptSinkAgent))]
internal sealed class AgentThrowsOptOkAgent { }

[FoundryAgent(Instructions = "Sink for agent-throws optional graph.")]
