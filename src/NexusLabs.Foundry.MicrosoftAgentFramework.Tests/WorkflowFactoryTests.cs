...
{
    private static IWorkflowFactory BuildWorkflowFactory(Func<AgentFrameworkBuilder, AgentFrameworkBuilder> configure)
    {
...
[FoundryAgent(Instructions = "Route customer queries to the right specialist.")]
[AgentHandoffsTo(typeof(BillingWfAgent))]
[AgentHandoffsTo(typeof(TechWfAgent))]
public sealed class TriageWfAgent { }

[FoundryAgent(Instructions = "Resolve billing and payment queries.")]
public sealed class BillingWfAgent { }

[FoundryAgent(Instructions = "Resolve technical support queries.")]
public sealed class TechWfAgent { }

[FoundryAgent(Instructions = "Review code changes as an expert reviewer.")]
[AgentGroupChatMember("wf-code-review")]
public sealed class ReviewerWfAgent { }

[FoundryAgent(Instructions = "Propose code changes and receive review feedback.")]
[AgentGroupChatMember("wf-code-review")]
public sealed class RevieweeWfAgent { }

[FoundryAgent(Instructions = "Agent with no handoff targets — triggers error path.")]
public sealed class NoHandoffWfAgent { }

[FoundryAgent(Instructions = "Agent in a group with only one member — triggers error path.")]
