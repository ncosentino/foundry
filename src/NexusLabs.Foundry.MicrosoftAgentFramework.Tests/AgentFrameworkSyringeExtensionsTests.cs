...
public sealed class AgentFrameworkBuilderExtensionsTests
{
    [Fact]
    ...
    public void UsingAgentFramework_FactoryOverload_RegistersAllInfrastructureSingletons()
    {
        ...
        var sp = new Syringe()
            .UsingReflection()
            .UsingAgentFramework(() => new AgentFrameworkBuilder
            {
    ...
    public void ConfigurePipelineMetrics_PopulatesPipelineMetricsOptions()
    {
        ...
        var syringe = new AgentFrameworkBuilder { ServiceProvider = serviceProvider };
    ...
    public void ConfigurePipelineMetrics_NullSyringe_Throws()
    {
        Assert.Throws<ArgumentNullException>(() =>
            AgentFrameworkBuilderExtensions.ConfigurePipelineMetrics(
                syringe: null!,
                configure: _ => { }));
    }
