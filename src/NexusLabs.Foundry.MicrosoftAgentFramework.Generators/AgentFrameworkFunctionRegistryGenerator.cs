...
/// Also discovers classes with [FoundryAgent] attributes and generates an agent registry.
...
public class AgentFrameworkFunctionRegistryGenerator : IIncrementalGenerator
{
    ...
    private const string ProgressSinksAttributeName = "NexusLabs.Foundry.MicrosoftAgentFramework.ProgressSinksAttribute";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        // [FoundryAgent] declared agent types → AgentRegistry + partial companions
        var agentClasses = context.SyntaxProvider
            .ForAttributeWithMetadataName(
                FoundryAgentAttributeName,
                predicate: static (s, _) => s is ClassDeclarationSyntax,
                transform: static (ctx, ct) => AgentDiscoveryHelper.GetFoundryAgentTypeInfo(ctx, ct))
            .Where(static m => m is not null);
    ...
    private static void ExecuteAll(
        ...
        ImmutableArray<FoundryAgentTypeInfo?> agentData,
        ...
        SourceProductionContext spc)
    {
        ...
        spc.AddSource("FoundryAgentFrameworkBootstrap.g.cs",
        ...
        spc.AddSource("AgentFrameworkBuilderExtensions.g.cs",
        ...
        configOptions.GlobalOptions.TryGetValue("build_property.FoundryDiagnostics", out var diagValue);
        ...
        // Partial companions for [FoundryAgent] classes declared as partial
        foreach (var agentType in validAgentTypes.Where(a => a.IsPartial))
        {
            ...
            spc.AddSource($"{safeTypeName}.FoundryAgent.g.cs",
