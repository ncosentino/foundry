...
using NexusLabs.Foundry.MicrosoftAgentFramework.Generators.CodeGen;
using NexusLabs.Foundry.MicrosoftAgentFramework.Generators.Models;
...
namespace NexusLabs.Foundry.MicrosoftAgentFramework.Generators
{
    ...
    public class AsyncLocalScopedGenerator : IIncrementalGenerator
    {
        private const string AsyncLocalScopedAttributeName =
            "NexusLabs.Foundry.MicrosoftAgentFramework.AsyncLocalScopedAttribute";
