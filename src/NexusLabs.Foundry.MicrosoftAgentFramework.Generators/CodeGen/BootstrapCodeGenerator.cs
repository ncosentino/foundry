...
// Foundry AgentFramework Module Initializer
#nullable enable
...
/// <summary>
/// Auto-registers source-generated Agent Framework types with the Foundry bootstrap.
/// Fires automatically when the assembly loads — no explicit <c>Add*FromGenerated()</c> calls needed.
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCodeAttribute(""NexusLabs.Foundry.MicrosoftAgentFramework.Generators"", ""1.0.0"")]
internal static class FoundryAgentFrameworkModuleInitializer
{{
    [ModuleInitializer]
    internal static void Initialize()
    {{
        global::NexusLabs.Foundry.MicrosoftAgentFramework.AgentFrameworkGeneratedBootstrap.Register(
        ...
        global::NexusLabs.Foundry.MicrosoftAgentFramework.AgentFrameworkGeneratedBootstrap.RegisterGraphTopology(
            () => AgentGraphTopologyRegistry.AllGraphs);
        global::NexusLabs.Foundry.MicrosoftAgentFramework.AgentFrameworkGeneratedBootstrap.RegisterAIFunctionProvider(
...
";
    ...
    public static string GeneratePartialCompanionSource(
        FoundryAgentTypeInfo agentType,
